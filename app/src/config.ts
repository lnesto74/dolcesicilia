...
export const newsConfig: NewsConfig = {
  ...
  testimonials: [
    {
      name: "Sarah Lim",
      role: "Food Writer, Singapore",
      text: "I've eaten tiramisu in Rome, Milan, and Venice. Enzo's Classico holds its own—perhaps because it doesn't try to be anything other than what it is: precise, balanced, uncompromising.",
      rating: 5,
    },
    {
      name: "Marco Bellini",
      role: "Italian Expat",
      text: "Most tiramisu abroad tastes like a memory diluted. This tastes like the real thing—because it is. Enzo understands restraint. That is rare.",
      rating: 5,
    },
    {
      name: "Jennifer Tan",
      role: "Regular Guest",
      text: "The Limoncello arrives every Sunday. It has become ritual. The consistency is remarkable—not just in flavor, but in care. You sense someone's hand in this.",
      rating: 5,
    },
  ],
