export interface MessageTemplate {
  ...
  description: string;
  body: string;
  /** Optional segment id (vip, win-back, etc.) — UI can suggest/select that audience */
  targetSegment?: string | null;
  /** launch = new product launch broadcast (respects messagePref) */
...
/** Format phone for wa.me links (Singapore default). */
